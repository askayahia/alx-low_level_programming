 ...
 * @e_ident: A pointer to an array contains ELF magic numbers.
...
/**
 * print_data - To print an ELF header data!
...
/**
 * print_osabi - It prints the OS/ABI of some ELF header.
 * @e_ident: A pointer to an array holding the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
 ...
 * @e_ident: A pointer to an array holding ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * Return: 0 on success!
 *
 * Description: In case the file is not an ELF File or
